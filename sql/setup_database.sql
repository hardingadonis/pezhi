...
(
	...
	type TEXT NOT NULL,
	source_wallet INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS transfer_trans
(
	id INTEGER,
	...
	FOREIGN KEY (target_wallet) REFERENCES wallet (id)
);
...
CREATE TABLE IF NOT EXISTS expense_trans
(
	id INTEGER,
	category_id INTEGER NOT NULL,
	target_id INTEGER,
